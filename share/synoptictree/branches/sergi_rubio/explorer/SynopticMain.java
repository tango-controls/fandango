...
// Time-stamp:    <2007-09-01, srubio><2003-01-16 15:12:9, erik>
// 
// 
// Description:       
...
public class SynopticMain extends Main {
    ...
    //public void init(String[] args) {
    	...
    	if (((HierarchyNode)deviceTree.getNextMatch(
    			args[0],0,javax.swing.text.Position.Bias.Forward).getLastPathComponent()).getConfig()!=null)
    		loadAttribsProfile();
