...
public class WebLauncher {
	 ...
	 * If value equal to false no authentication will be displa in when lauching application but the web server could forced to open one.
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length > 1)
		{
			try
			{
				...
				WebServerClient defaultWebServerClient = new WebServerClient(url);
