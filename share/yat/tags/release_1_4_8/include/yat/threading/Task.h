...
public:
  ...
  //- MsgQ low water mark mutator (unit dependent)
  void msgq_lo_wm (size_t _lo_wm);
  
  //- MsgQ low water mark accessor (unit dependent)
  size_t msgq_lo_wm () const;
  
  //- MsgQ high water mark mutator (unit dependent)
  void msgq_hi_wm (size_t _hi_wm);
  
  //- MsgQ high water mark accessor (unit dependent)
  size_t msgq_hi_wm () const;
  
  //- MsgQ high water mark accessor (unit dependent)
  const MessageQ::Statistics & msgq_statistics () const;
