...
public:
  ...
  inline double elapsed_msec () const             
  { 
    struct timeval now;
    ::gettimeofday(&now, NULL);
  ...
  inline double elapsed_usec () const             
  { 
    struct timeval now;
    ::gettimeofday(&now, NULL);
...
public:
  ...
  //- for a disabled Timeout, returns an "infinite value" 
  inline TimeoutValue time_to_expiration () const
  {
