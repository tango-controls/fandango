/*!
 * \file    Mutex.h
 * \brief   Header file of the YAT portable mutex class.
...
// ----------------------------------------------------------------------------
// almost complete rewrite of omniThread portable threading impl.
...
// ----------------------------------------------------------------------------
template <typename LOCK_TYPE = yat::Mutex> class YAT_DECL AutoMutex
{
