...
//! 
// ============================================================================
template <class T, class L = yat::NullMutex>
...
public:
   ...
   * Constructor. 
   */
  CircularBuffer (void) throw (Exception);

  /**
   * Constructor. 
   */
  CircularBuffer (size_t capacity) throw (Exception);
   ...
   */
  const yat::Buffer<T> & ordered_data (void)
    throw (Exception);
