...
public:
  ...
  //! Return the socket protocols.
	Protocol get_protocol (void) const
    throw (SocketException);
...
protected:
  ...
  //! Giving a yat socket option name, return its native socket option code.
  //!
  //! \param o The name of option the to native socket option code.
