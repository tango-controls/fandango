...
// ============================================================================
template <typename T>
Buffer<T>::Buffer (size_t _capacity, bool _clear) throw (Exception) 
...
// ============================================================================
template <typename T>
Buffer<T>::Buffer (size_t _length, T* _base) throw (Exception) 
 : base_(0), capacity_(0), length_(0)
{
  //- allocate the buffer 
...
// ============================================================================
template <typename T> 
Buffer<T>::Buffer (const Buffer<T>& _src) throw (Exception)
 : base_(0), capacity_(0), length_(0)
{
  //- allocate the buffer 
...
// ============================================================================
template <typename T> 
void Buffer<T>::capacity (size_t _new_capacity, bool _keep_content) throw (Exception)
{
...
// ======================================================================
template <typename T>
ImageBuffer<T>::ImageBuffer (size_t _width, size_t _height) throw (Exception) 
...
// ======================================================================
template <typename T>
ImageBuffer<T>::ImageBuffer (size_t _width, size_t _height, T *base) throw (Exception) 
...
// ======================================================================
template <typename T>
ImageBuffer<T>::ImageBuffer (const ImageBuffer<T>& im) throw (Exception) 
: Buffer<T>(im),
  width_(im.width_),
  height_(im.height_)
{
...
// ============================================================================
template <typename T>
SharedBuffer<T>::SharedBuffer (size_t _capacity) throw (Exception)
...
// ============================================================================
template <typename T>
SharedBuffer<T>::SharedBuffer(size_t _length, T* _base) throw (Exception)
...
// ============================================================================
template <typename T> 
SharedBuffer<T>::SharedBuffer(const Buffer<T>& _src) throw (Exception)
...
CircularBuffer<T,L>::CircularBuffer(void) throw (Exception)
  : wp_(0), 
    frozen_(false),
    data_ (0),
    ordered_data_ (0),
...
// ============================================================================
template <typename T, typename L>
CircularBuffer<T,L>::CircularBuffer(size_t _capacity) throw (Exception)
  : wp_(0), 
    frozen_(false),
    data_ (0),
    ordered_data_ (0),
...
// ============================================================================
template <typename T, typename L> 
void CircularBuffer<T,L>::capacity (size_t _capacity) throw (Exception)
{
  yat::AutoMutex<L> guard(this->lock_);
...
// ============================================================================
template <typename T, typename L>
void CircularBuffer<T,L>::push(T _data) throw (Exception)
{ 
  yat::AutoMutex<L> guard(this->lock_);
  ...
  {
    THROW_YAT_ERROR("PROGRAMMING_ERROR", "Circular buffer was not initialized properly", "CircularBuffer<T,L>::push");
  } 
...
// ============================================================================
template <typename T, typename L> 
const Buffer<T> & CircularBuffer<T,L>::ordered_data (void) throw (Exception)
{
  yat::AutoMutex<L> guard(this->lock_);
