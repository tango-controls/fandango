...
#       define YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( TYPEID, TYPE )                      \
        ...
        switch (prop_infos[prop_name])
        {
          ...
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::UINT8 ,         uint8_t);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::INT16 ,         int16_t);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::UINT16 ,        uint16_t);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::INT32 ,         int32_t);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::UINT32 ,        uint32_t);
          ...
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::INT16_VECTOR ,  std::vector<int16_t>);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::UINT16_VECTOR , std::vector<uint16_t>);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::INT32_VECTOR ,  std::vector<int32_t>);
          YAT4TANGO_PUSH_PLUGIN_PROP_TYPE( yat::PlugInPropType::UINT32_VECTOR , std::vector<uint32_t>);
